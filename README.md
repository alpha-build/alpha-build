...
2. [Usage](#Usage)
   1. [Goals - what tools we run](#Goals-whattoolswerun)
   2. [Targets - what files we run the tools on](#Targets-whatfileswerunthetoolson)
3. [AlphaBuild structure](#AlphaBuildstructure)
4. [IDE Integration](#IDEIntegration)
5. [Example monorepo running AlphaBuild](#Examplemonorepo)
6. [Common admin actions](#Commonadminactions)
   1. [Installation](#Installation)
   2. [Upgrade](#Upgrade)
   3. [Change goal definitions](#Changegoaldefinitions)
   4. [Add goals](#Addgoals)
   5. [Update PYTHONPATH](#UpdatePYTHONPATH)
   6. [See/Change tools config](#See/Changetoolsconfig)
